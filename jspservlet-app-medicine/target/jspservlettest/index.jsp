			...
			<div id=<%= "grid"+i %> class="grid">
				<div class="grid-container">
					...
					<div class="grid-item">
						...
						<p>
							<div class="icons">
								<a id=<%= "editMedicine"+i %> href="edit?id=<c:out value='${medicine.medicineId }' />"><i class="bi bi-pencil-square"></i></a>
								<a id=<%= "deleteMedicine"+i %> href="delete?id=<c:out value='${medicine.medicineId }' />"><i class="bi bi-trash3-fill" ></i></a>
